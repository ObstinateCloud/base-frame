...
public class ExcelExportTemplateColFeTest {
	...
	public void one() throws Exception {
		TemplateExportParams params = new TemplateExportParams(
		    "template/excel/for_Col.xlsx");
		params.setColForEach(true);
		Workbook book = ExcelExportUtil.exportExcel(params, value);
		//PoiMergeCellUtil.mergeCells(book.getSheetAt(0), 1, 0,1);
		FileOutputStream fos = new FileOutputStream("./target/ExcelExportTemplateColFeTest_one.xlsx");
		book.write(fos);
		fos.close();
	...
	public void two() throws Exception {
		TemplateExportParams params = new TemplateExportParams(
				"template/excel/for_Col.xlsx", 1);
		params.setColForEach(true);
		Workbook book = ExcelExportUtil.exportExcel(params, value);
		FileOutputStream fos = new FileOutputStream("./target/ExcelExportTemplateColFeTest_two.xlsx");
		book.write(fos);
		fos.close();
